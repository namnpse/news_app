package com.namnp.newsapp.data.api
...
class NewsAPIServiceTest {
    ...
    val TEST_FILE = "newsresponse.json"
...
//            For the mockwebserver, not adding the base url (baseUrl(server.url("")) above)
//            -> remove BASE_URL from the url
        }
    }
